...
public:
    ...
    void report()
    {
        cout << book_number << setw(20) << book_name << setw(25) << author_name << endl;
    }
...
void modify_book()
{
    ...
    while (fp.read((char*)&bk, sizeof(book)) && found == 0)
    {
        if (strcmp(bk.getbooknumber(), n) == 0)
        {
            ...
            bk.modify_book();
            int pos = -1 * static_cast <signed int>(sizeof(bk));
...
void modify_student()
{
    ...
    while (fp.read((char*)&st, sizeof(student)) && found == 0)
    {
        if (strcmp(st.get_ID_number(), n) == 0)
        {
            ...
            st.modify_student();
            int pos = -1 * static_cast<signed int>(sizeof(st));
            fp.seekp(pos, ios::cur);
            fp.write((char*)&st, sizeof(student));
            cout << "\n\n\t Record Updated Successfully...";
            found = 1;
...
void display_all_students()
{
    ...
    cout << "\n\n\t\tSTUDENT LIST\n\n";
    cout << "\tID Number." << setw(20) << "Name" << setw(10) << "Book Issued\n";
    while (fp.read((char*)&st, sizeof(student)))
    {
        st.report();
    }
